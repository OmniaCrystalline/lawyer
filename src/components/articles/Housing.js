...
export const Housing = () => {
    return (
      <>
        <Helmet>
          <title>Житлові спори | Оренда, Виселення | Адвокат Львів</title>
          <meta name="description" content="Житлові спори у Львові. Адвокат допоможе з орендною платою, ремонтом, виселенням, договорами оренди, відшкодуванням збитків." />
          <meta name="keywords" content="житлові спори, оренда, виселення, адвокат Львів, житлові питання" />
          <link rel="canonical" href="https://lawyer-help5.firebaseapp.com/services/housing" />
          <meta property="og:title" content="Житлові спори | Адвокат Львів" />
          <meta property="og:description" content="Професійна допомога з житлових спорів у Львові." />
        </Helmet>
        <Box as='section'>
